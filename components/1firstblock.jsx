  ...
  <div className=" -z-7  relative">
    <div className="relative">
      <div className=" image-container " >      
        ...
        alt="background" 
        className="background-image image-res w-full rounded-b-xl sm:rounded-[40px] " />
      </div>
      <a className="absolute  text-white text-big  "> <p>Where <a className="text-[#E7F40D] ">excellence</a> meets</p> <p> <a className="text-[#E7F40D] ">flavor</a> discover the best</p>  in chips with us.</a>
